<template>
	<div class="layout-navbars-breadcrumb-user pr15" :style="{ flex: layoutUserFlexNum }">
		...
		<el-divider direction="vertical" style="color: #fff" />
		<div class="layout-navbars-breadcrumb-user-icon">
...
import { logout } from '@cqdcg/admin/api/login/index';
...
import { useMsg } from '@cqdcg/admin/stores/msg';
import { fetchUserMessageList } from '@cqdcg/admin/api/admin/message';
import PersonalDrawer from '@cqdcg/admin/views/admin/system/user/personal';
import avatar from '/@/assets/login/avatar.png';
import GlobalWebsocket from '@cqdcg/admin/components/Websocket/index';

// 引入组件
// const GlobalWebsocket = defineAsyncComponent(() => import('@cqdcg/admin/components/Websocket/index.vue'));
